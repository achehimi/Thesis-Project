...
```{r}
simple_points_plot <- ggplot(cardio, aes(x = date, y = outcome)) +
  geom_point(size = 2) +
  geom_vline(xintercept = as.Date("2020-03-01"), color = "red", linetype = "dashed", size = 1) +
  labs(
    title = "Weekly Cardiovascular Hospitalizations in MA",
    x = "Date",
...
ggsave("simple_points_plot.png", plot = simple_points_plot, width = 8, height = 6, dpi = 300)
```
